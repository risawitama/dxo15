...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/platform/bluetooth/libldacBT_bco:$(TARGET_COPY_OUT_VENDOR)/lib/libldacBT_bco.so \
    $(LOCAL_PATH)/platform/bluetooth/libldacBT_bco:$(TARGET_COPY_OUT_VENDOR)/lib64/libldacBT_bco.so
